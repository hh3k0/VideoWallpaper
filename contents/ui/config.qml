...
ColumnLayout {
    ...
    property bool cfg_DoublePlayer: false
    ...
    RowLayout {
        ...
        TextField {
            ...
            DropArea {
                ...
                anchors.fill: parent
                onDropped: {
                    cfg_VideoWallpaperBackgroundVideo = drop.urls.toString()
        ...
        Button {
            ...
            PlasmaCore.IconItem {
                ...
                PlasmaCore.ToolTipArea {
                    anchors.fill: parent
                    subText: "Use typed/pasted video path"
                }
            }
            MouseArea {
                anchors.fill: parent
                onClicked: { 
                    cfg_VideoWallpaperBackgroundVideo = videoPathLine.text
                }
            }
        }
        Button {
