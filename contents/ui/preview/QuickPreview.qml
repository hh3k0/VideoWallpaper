...
Rectangle {
    ...
    property var stopPlace: Math.floor(Math.random() * 95 + 5 )
    ...
    VideoOutput {
        ...
        Rectangle {
            ...
            anchors.left: videoView.left; anchors.bottom: videoView.bottom;
        ...
        Rectangle {
            ...
            radius: height / 2
            anchors.left: playButton.right; anchors.verticalCenter: actionStripe.verticalCenter;
        }
    ...
    Timer {
        ...
        onTriggered: {
            mediaplayer.seek( mediaplayer.duration * 10 / stopPlace )
            mediaplayer.pause()
        }
    }
